...
g_aimfix::
    Adjusts projectile and bullet aim from weapon muzzle toward the player's
    crosshair trace. Default value is 0 (disabled).
       - 0 - original Quake 2 aim behaviour
       - 1 - aim at crosshair trace from player view
